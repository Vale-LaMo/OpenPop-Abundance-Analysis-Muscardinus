...
master_dates <- sort(unique(as.Date(c(
  ...
  "2022-09-05", "2022-09-20", "2022-10-15",
  #"2022-10-20", "2022-11-05", "2022-11-20", "2022-12-05", 
  "2023-05-15", "2023-06-15", "2023-07-15", "2023-08-05",
  "2023-08-20", "2023-09-05", "2023-09-20", # "2023-10-10",
...
areas <- c("S3_clean", "R3_clean")#, "S1870", "R1200", "R1870", "R1990")

# -----------------------------------------------------------
# CHIEDERE AD ANNA DI PREPARARE FILE ANCHE PER LE ALTRE AREE
...
for (i in 1:length(areas)) {
  # 1. Load data
  temp_data <- readxl::read_xlsx("data/data_abundance_hierarchical.xlsx", sheet = areas[i])
